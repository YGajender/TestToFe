              ...
              <div className="counter-wrapper">
                <div className="row">
                  {[
                    {
                      img:
                        "https://bibaanbackend.webspulses.com/visuticareer/assets/images/h1.png",
                      number: "22,000+",
                      text: "Positive Impacted Our Company"
                    },
                    {
                      img:
                        "https://bibaanbackend.webspulses.com/visuticareer/assets/images/h2.png",
                      number: "22,000+",
                      text: "Positive Impacted Our Company"
                    },
                    {
                      img:
                        "https://bibaanbackend.webspulses.com/visuticareer/assets/images/h3.png",
                      number: "22,000+",
                      text: "Positive Impacted Our Company"
                    },
                    {
                      img:
                        "https://bibaanbackend.webspulses.com/visuticareer/assets/images/h4.png",
                      number: "22,000+",
                      text: "Positive Impacted Our Company"
                    }
                  ].map((counter, index) => (
