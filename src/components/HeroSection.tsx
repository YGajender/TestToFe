...
const HeroSection = () => {
  return (
    <section className="hero-section">
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <div className="img-item">
              ...
              <Image src={banner_line}  alt="line-img" className="img-fluid banner-line"/>
      ...
      <div className="modal video fade" id="videoModal" aria-labelledby="videoModalLabel" aria-hidden="true">
